                ...
                <div id="sidebar-scroll">
                  ...
                  <!-- END User Info -->
                        ...
                        <ul class="sidebar-nav">
                          ...
                          <ul>
                            <li>
                                <a href="../root/usuarioManager.php"><i class="fa fa-user sidebar-nav-icon "></i>Crear Usuario</span></a>
                            </li>
                            <li>
                                <a href="../root/centroCostos.php"><i class="fa fa-building sidebar-nav-icon "></i>Crear Empresa</span></a>
                            </li>
                          </ul>
                        </ul>
