                ...
                <div id="sidebar-scroll">
                  ...
                  <!-- END User Info -->
                        ...
                        <ul class="sidebar-nav">
                          ...
                          <ul>
                            <li>
                                <a href="../manager/usuarioReport.php"><i class="fa fa-edit sidebar-nav-icon "></i>Usuario reportes</span></a>
                            </li>
                            <li>
                                <a href="../manager/crearVale.php"><i class="fa fa-ticket sidebar-nav-icon "></i>Generar vales</span></a>
                            </li>
                            <li>
                                <a href="../manager/buscarmes.php"><i class="fa fa-calendar sidebar-nav-icon "></i>Servicios</span></a>
                            </li>
                          </ul>
                        </ul>
