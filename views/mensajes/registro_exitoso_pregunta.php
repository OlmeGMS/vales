       ...
       <div id="error-container">
           <div class="error-options">
               <h3><i class="fa fa-chevron-circle-left text-muted"></i>
                 <?php switch ($rol) {
                 case '1':
                    echo '<a href="../SuperAdministrador/banco_preguntas.php">Regresar</a></h3>';
                   break;
                   case '2':
                      echo '<a href="../Administrador/banco_preguntas.php">Regresar</a></h3>';
                     break;
                     case '3':
                        echo '<a href="../Rector/banco_preguntas.php">Regresar</a></h3>';
                       break;
                       case '4':
                          echo '<a href="../Coordinador/banco_preguntas.php">Regresar</a></h3>';
                         break;
                         case '5':
                            echo '<a href="../JefeArea/banco_preguntas.php">Regresar</a></h3>';
                           break;
                           case '6':
                              echo '<a href="../Docente/banco_preguntas.php">Regresar</a></h3>';
                             break;
                             case '7':
